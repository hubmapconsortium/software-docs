...
| assay_type | The specific type of assay being executed. | Shared by all types | seqFISH | True |   |   |   |   |   |
...
| number_of_barcode_probes | Number of barcode probes targeting mRNAs (eg. 24,000 barcode probes = 24,000 mRNAs - 1 per mRNA of interest) | Unique to this type |   | True |   |   | integer |   |   |
| number_of_barcode_regions_per_barcode_probe | Number of barcode regions on each mRNA barcode probe (the paper describes mRNA probes with 4 barcoded regions) | Unique to this type |   | True |   |   | integer |   |   |
